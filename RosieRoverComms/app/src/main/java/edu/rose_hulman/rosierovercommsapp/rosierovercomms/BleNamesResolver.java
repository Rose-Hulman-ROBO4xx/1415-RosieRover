...
public class BleNamesResolver {
	...
	static {
        //bluno stuff
        mServices.put("0000dfb1-0000-1000-8000-00805f9b34fb", "Serial Port UUID");
        mServices.put("0000dfb2-0000-1000-8000-00805f9b34fb", "Command UUID");
        mServices.put("00002a24-0000-1000-8000-00805f9b34fb", "Model Number String UUID");
        ...
        //Bluno stuff
        mCharacteristics.put("0000dfb1-0000-1000-8000-00805f9b34fb", "Serial Port UUID");
        mCharacteristics.put("0000dfb2-0000-1000-8000-00805f9b34fb", "Command UUID");
        mCharacteristics.put("00002a24-0000-1000-8000-00805f9b34fb", "Model Number String UUID");


        //their prewritten crap
