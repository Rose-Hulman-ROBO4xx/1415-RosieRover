...
This is the class that has most of the methods that we needed to call. Use for reference when
...
public class BleWrapper {
    ...
    public void getCharacteristicValue(BluetoothGattCharacteristic ch) {
        ...
        //my Bluno stuff
        if(uuid.equals(BleDefinedUUIDs.Characteristic.SerialPortUUID)) { //

        }else if(uuid.equals(BleDefinedUUIDs.Characteristic.CommandUUID)) { //

        }else if(uuid.equals(BleDefinedUUIDs.Characteristic.ModelNumberStringUUID)) { //
