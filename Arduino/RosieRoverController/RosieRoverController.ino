...
unsigned char controllerState[23];
...
//  Serial.println("");
  ...
  for(int i = 0; i < 4; i++){
    ...
    //Serial1.print(",");
    controllerState[i+17]=(joystick[i]/4);
  }
  for(int i = 0; i < 2; i++){
    //Serial1.print(AnalogButton[i]);
    //Serial1.print(",");
    controllerState[i+21]=(AnalogButton[i]/4);
  }
  //Serial1.println("");
  //Serial1.println(-1);
  commandString="";
  for(int i=0;i<23;i++){
    //Serial1.print((int)controllerState[i]);
    //Serial.print((int)controllerState[i]);
    //Serial1.print(",");
    //Serial.print(",");
    commandString += String(controllerState[i]);
